...
$aryKaryawan = ArrayHelper::map(Karyawan::find()->where("KAR_STS<>3")->all(), 'KAR_NM','KAR_NM');
//$aryKaryawan = ArrayHelper::map(Karyawan::find()->where("STATUS<>3 AND KAR_STS<>3")->all(), 'KAR_NM','KAR_NM');
			
// $aryKaryawan = ArrayHelper::map(Karyawan::find()->where("STATUS<>3 AND KAR_STS<>3")->all(), function($model, $defaultValue) {
	...
	*/
	$gvAbsenLog=GridView::widget([
		...
		'pjaxSettings'=>[
		 ...
		 'panel' => [
					'heading'=>'<h3 class="panel-title" style="font-family:tahoma, arial, sans-serif;font-size:9pt;text-align:left;"><b>DAILY OVERTIME</b></h3>',
					'type'=>'warning',
