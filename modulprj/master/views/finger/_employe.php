	...
	*/	
	...
	$attDinamik[]=[
		...
		'buttons' => [
			'create' =>function ($url, $model){
				return  tombolCreateFinger($model);
			}
		], 
	...
	$emp_active= GridView::widget([
		...
		'rowOptions'   => function ($model, $key, $index, $grid) {
			return ['id' => $model->KAR_ID,'onclick' => '$.pjax.reload({
				url: "'.Url::to(['/master/finger/index']).'?Kar_fingerSearch[KAR_ID]="+this.id,
				container: "#finger-emp",
				timeout: 1000,
			});'];
		...
		'panel'=>[
			'heading'=>'<h3 class="panel-title">Karyawan List</h3>',
			'before'=>false,
			'footer'=>false,
		],
		'pjax'=>true,
