...
$(document).on('click','#emp-finger-create', function(ehead){ 			  
	$('#emp-finger-modal-create').modal('show')
	.find('#emp-finger-content-create').html('<i class=\"fa fa-2x fa-spinner fa-spin\"></i>')
