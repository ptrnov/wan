...
use yii\helpers\Url;
	...
	$aryField= [
		['ID' =>0, 'ATTR' =>['FIELD'=>'STT_OT_DPN','SIZE' => '20px','label'=>'ID','align'=>'left']],
		['ID' =>1, 'ATTR' =>['FIELD'=>'STT_OT_DPN_NM','SIZE' => '10px','label'=>'Status','align'=>'left']],
	];	
	...
	*/	
	...
	$ttOptStatus= GridView::widget([
		'id'=>'timetable-option-status',
		'dataProvider' => $dataProviderStt,
		'filterModel' => $searchModelStt,
