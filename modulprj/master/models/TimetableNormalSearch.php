...
/**
 * TimetableNormalSearch represents the model behind the search form about `modulprj\master\models\TimetableNormal`.
 */
class TimetableNormalSearch extends TimetableNormal
{
    /**
     * @inheritdoc
     */
