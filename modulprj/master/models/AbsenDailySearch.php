...
{	
    ...
    public function rules()
    {
   	...
   	public function getScripts(){
		return Yii::$app->db->createCommand("CALL absensi_log('bulan','2016-03-23');")->queryAll();             
	}
	...
	*/
	public function dailyFieldTglRange(){
		$dailyAbsensi= Yii::$app->db->createCommand("CALL absensi_calender('bulan','2016-03-23')")->queryAll();  
